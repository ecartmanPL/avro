...
public class Message extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4487537721236196365L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Message\",\"namespace\":\"net.siekiera.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"header\",\"type\":[\"string\",\"null\"]},{\"name\":\"content\",\"type\":[\"string\",\"null\"]}]}");
   ...
   */
  public Message(java.lang.Integer id, java.lang.CharSequence header, java.lang.CharSequence content) {
    this.id = id;
    this.header = header;
   ...
   */
  public static net.siekiera.avro.Message.Builder newBuilder() {
    return new net.siekiera.avro.Message.Builder();
  }
   ...
   * @return A new Message RecordBuilder
   */
  public static net.siekiera.avro.Message.Builder newBuilder(net.siekiera.avro.Message.Builder other) {
    return new net.siekiera.avro.Message.Builder(other);
  }
   ...
   * @return A new Message RecordBuilder
   */
  public static net.siekiera.avro.Message.Builder newBuilder(net.siekiera.avro.Message other) {
    return new net.siekiera.avro.Message.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Message>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.siekiera.avro.Message.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(net.siekiera.avro.Message other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.siekiera.avro.Message.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.siekiera.avro.Message.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.siekiera.avro.Message.Builder setHeader(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.siekiera.avro.Message.Builder clearHeader() {
      header = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.siekiera.avro.Message.Builder setContent(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.siekiera.avro.Message.Builder clearContent() {
      content = null;
